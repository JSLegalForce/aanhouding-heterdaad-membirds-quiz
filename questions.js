const ALLE_VRAGEN = [
  {
    thema: "Mededeling strafbaar feit",
  ...
  {
    thema: "Uitreiking folder rechten",
  ...
  {
    thema: "Heterdaad na gestaakte zoektocht",
  ...
  {
    thema: "BOA als opsporingsambtenaar of burger",
  ...
  {
    thema: "Bewijskracht waarneming burger vs opsporingsambtenaar",
    ...
    juist: 1,
    uitleg: "Een opsporingsambtenaar die een aanhouding verricht maakt hiervan proces-verbaal (Pv) op (art. 152 lid 1 Sv). Een Pv van een opsporingsambtenaar heeft unieke bewijskracht. Het bewijs dat de verdachte het tenlastegelegde feit heeft gepleegd, kan door de rechter worden aangenomen op het Pv van een opsporingsambtenaar (art. 344 lid 2 Sv). Als de burger een aanhouding verricht wordt hiervan een getuigenverklaring of aangifte opgenomen, hetgeen 1 bewijsmiddel is. De rechter kan op basis van één verklaring niet aannemen dat verdachte het tenlastegelegde feit heeft gepleegd (art. 342 lid 2 Sv).",
